    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} action="" className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input onChange={e => setCoursePrice(e.target.value)} value={coursePrice} placeholder='0' className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' type="number" required/>
          </div>
        ...
        <div>
          <p>Discount %</p>
          <input type="number" value={discount} onChange={e => setDiscount(e.target.value)} placeholder='0' min={0} max={100} className='outline-none md:py-2.5 w-28 px-3 rounded border border-gray-500' required />
        </div>
        ...
        <div>
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer my-2' onClick={()=> handleChapter('add')}>+ Add Chapter</div>
        ...
        <button type='submit' className='bg-gray-900 text-white w-max py-2.5 px-8 rounded'>ADD</button>
      </form>
    </div>
  )
}
